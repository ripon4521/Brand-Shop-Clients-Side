...
const Fetaures = () => {
    return (
        <div className=' my-10'>
          ...
          <div className='container mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 pl-16 md:pl-0 lg:pl-0 gap-5 '>
          <div className='float-left my-5 bg-white shadow-lg rounded-2xl px-6 py-4 md:ml-20 lg:ml-0  w-[250px]'>
            ...
            <div className='float-left my-5 bg-white shadow-lg rounded-2xl  md:ml-20 lg:ml-0 px-6 py-4 w-[250px]'>
